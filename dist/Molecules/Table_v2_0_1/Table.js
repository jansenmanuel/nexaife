...
var _NoData = _interopRequireDefault(require("./_components/NoData"));
var _CurrentPage = require("../../Utils/Pagination/CurrentPage");
...
var Table = function Table(_ref) {
  ...
  var itemsOnCurrentPage = (0, _react.useMemo)(function () {
    return (0, _CurrentPage.calculateItemsOnCurrentPage)(currentPage, currentPageSize, totalData);
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    loading: loading,
    locale: {
      emptyText: /*#__PURE__*/_react.default.createElement(_NoData.default, null)
    },
