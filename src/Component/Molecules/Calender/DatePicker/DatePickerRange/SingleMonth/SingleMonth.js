        ...
        >
          <Div className={`react-calendar-container ${props.classCalender}`}>
            <Div className="react-datepickerrange__toper">
              <Div className="react-datepickerrange__start_singgle">
                <Paragraph
                  className="react-datepicker__headYear"
                  value={
                    date[0] === undefined || date[0] === null
                      ? ""
                      : date[0].getFullYear().toString()
                  }
                />
                <Div className="react-date-header">
                  <Paragraph
                  ...
                  />
                  <Span className="react-datepicker__headDate" value="-" />
                  <Paragraph
                    className="react-datepicker__headDate"
                    value={
