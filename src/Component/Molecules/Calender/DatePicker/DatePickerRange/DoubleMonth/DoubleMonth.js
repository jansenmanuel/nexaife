      ...
      >
        <Div className={style.Input}>
          <Input
            ...
            onClick={props.disabled ? () => {} : props.handleVisibility}
            onChange={() => {}}
        ...
        >
          <Div className={`react-calendar-container-double ${props.classCalender}`}>
          <Div className="react-datepickerrange__toper">
              <Div className="react-datepickerrange__start">
                <Paragraph
                  className="react-datepicker__headYear"
                  value={
                    props.date[0] === undefined || props.date[0] === null
                      ? ""
                      : props.date[0].getFullYear().toString()
                  }
                />
                <Paragraph
                  ...
                  value={
                    props.date[0] === undefined || props.date[0] === null
                      ? ""
                      : moment(props.date[0]).format("ddd, MMM DD").toString()
                  }
                />
              </Div>
              <Div className="react-datepickerrange__end">
                <Paragraph
                  className="react-datepicker__headYear"
                  value={
                    props.date[1] === undefined || props.date[1] === null
                      ? ""
                      : props.date[1].getFullYear().toString()
                  }
                />
                <Paragraph
                  className="react-datepicker__headDate"
                  value={
                    props.date[1] === undefined || props.date[1] === null
                      ? ""
                      : moment(props.date[1]).format("ddd, MMM DD").toString()
                  }
                />
              </Div>
            </Div>
            <Calendar
              ...
              formatMonth={(locale, date) => moment(new Date(date)).format("MMM")}
              formatShortWeekday={(locale, date) =>
                moment(new Date(date)).format("dd").substr(0, 1)
              }
            />
            <Div>
              <ActionDatePicker
