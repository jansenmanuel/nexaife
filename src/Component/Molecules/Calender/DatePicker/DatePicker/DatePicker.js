...
//   from '../../../../Utils/CustomHook/UseComponentVisible';
...
//     const e = await {
//       target: {name: props.name, value: date.toLocaleDateString('en-CA'), type: "date", validity: true},
//     };
//     setInputDate(date)
//     props.onChange(e);
//   };
//   const onChange = e => {
//     props.onChange(e);
//     setInputDate(tes(e.target.value));
//   };
...
//     }else
//     if (val.length > 10) {
//       setDate(value = new Date("12/12/2100"))
//       return (value = new Date("12/12/2100"));
//     }
//     else{
//       setDate(value = new Date(val))
//       return value;
//     }
...
//                 className={`${props.classInput} ${style.InputDate}`}
//                 maxLength={10}
//                 onChange={onChange}
//                 onKeyDown={keyDown}
