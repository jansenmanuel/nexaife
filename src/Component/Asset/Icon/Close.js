...
const Close = ({ onClick, id, size, color, className }) => {
    return (
        <svg onClick={onClick}
             id={id}
             width={size}
